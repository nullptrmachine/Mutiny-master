...
void ImDrawList::AddText(float font_size, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end)
{
	AddText(GImGui->Font, font_size, pos, col, text_begin, text_end);
}
...
bool ImFontAtlas::Build()
{
	...
	for (int input_i = 0; input_i < ConfigData.Size; input_i++)
	{
		...
		dst_font->FallbackGlyph = nullptr; // Always clear fallback so FindGlyph can return NULL. It will be set again in BuildLookupTable()
