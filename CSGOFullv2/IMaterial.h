...
#define COMPRESSED_NORMALS_TYPE						COMPRESSED_NORMALS_COMBINEDTANGENTS_UBYTE4
	...
	public:
		const char* GetName()
		{
			typedef const char*(__thiscall* GetActualWidth_t)(void*);
			return GetVFunc<GetActualWidth_t>(this, 0)(this);
		}

		int GetActualWidth()
		{
			typedef int(__thiscall* GetActualWidth_t)(void*);
			return GetVFunc<GetActualWidth_t>(this, 3)(this);
		}

		int GetActualHeight()
		{
			typedef int(__thiscall* GetActualHeight_t)(void*);
			return GetVFunc<GetActualHeight_t>(this, 4)(this);
		}
	};
	...
	public:
		int Release()
		{
			typedef int(__thiscall* Release_t)(void*);
			return GetVFunc<Release_t>(this, 1)(this);
		}

		ITexture* GetRenderTarget()
		{
			typedef ITexture*(__thiscall* GetRenderTarget_t)(void*);
			return GetVFunc<GetRenderTarget_t>(this, 7)(this);
		}

		void SetRenderTarget(ITexture* pTexture)
		{
			typedef void(__thiscall* SetRenderTarget_t)(void*, ITexture*);
			GetVFunc<SetRenderTarget_t>(this, 6)(this, pTexture);
		}

		void PushRenderTargetAndViewport()
		{
			typedef void(__thiscall* PushRenderTargetAndViewport_t)(void*);
			GetVFunc<PushRenderTargetAndViewport_t>(this, 119)(this);
		}

		void PopRenderTargetAndViewport()
		{
			typedef void(__thiscall* PopRenderTargetAndViewport_t)(void*);
			GetVFunc<PopRenderTargetAndViewport_t>(this, 120)(this);
		}
		...
		)
		{
			...
			GetVFunc<DrawScreenSpaceRectangle_t>(this, 114)(
				this, pMaterial,
