...
public:
	...
	virtual const CUtlVectorSimple *GetWeaponProgressionForCurrentModeCT() = 0;//CUtlVector< WeaponProgression > *GetWeaponProgressionForCurrentModeCT() = 0;
	virtual const CUtlVectorSimple *GetWeaponProgressionForCurrentModeT() = 0;//CUtlVector< WeaponProgression > *GetWeaponProgressionForCurrentModeT() = 0;
...
inline IGameTypes* GetGameTypes() { return *g_pGameTypes; }