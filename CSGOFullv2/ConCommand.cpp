...
static int SIMULATE_CMDS_TWICE;
static bool manuallystoppedcommunications;
static bool stopfreezing;
static float totaltimefrozen;
static float totaltimeunfrozen;
