...
void CUtlSymbol::Initialize()
{
	...
	//static bool symbolsInitialized = nullptr;
	bool &symbolsInitialized = *StaticOffsets.GetOffsetValueByType<bool*>(_symbolsInitialized);
...
public:
	...
	{
		//TODO: FIX ME: If we unload the cheat in the future will this crash the game due to this memory being deleted?
		//if (*CUtlSymbol::s_pSymbolTable)
		//{
...
{
	CUtlSymbol tmp;
	return *StaticOffsets.GetOffsetValueByType<CUtlSymbol*(__thiscall*)(const CUtlSymbolTable*, CUtlSymbol*, const char*)>(_FindString)(this, &tmp, pString);
...
{
	CUtlSymbol res;
	return *StaticOffsets.GetOffsetValueByType< CUtlSymbol*(__thiscall*) (CUtlSymbolTable*, CUtlSymbol*, const char*)>(_AddString)(this, &res, pString);
