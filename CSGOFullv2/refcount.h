...
{
public:
	static int Increment(int *p) { return ThreadInterlockedIncrement((int *)p); }
	static int Decrement(int *p) { return ThreadInterlockedDecrement((int *)p); }
};
...
class __declspec(novtable) CRefCountServiceBase
{
protected:
...
class __declspec(novtable) CRefCountServiceDestruct
{
protected:
...
class __declspec(novtable) CRefCounted : public REFCOUNT_SERVICE
{
public:
	virtual ~CRefCounted() {}
...
class __declspec(novtable) CRefCounted1 : public BASE1,
...
class __declspec(novtable) CRefCounted2 : public BASE1, public BASE2,
	public REFCOUNT_SERVICE
{
public:
...
class __declspec(novtable) CRefCounted3 : public BASE1, public BASE2, public BASE3,
	public REFCOUNT_SERVICE
{
...
class __declspec(novtable) CRefCounted4 : public BASE1, public BASE2, public BASE3, public BASE4,
	public REFCOUNT_SERVICE
{
public:
...
class __declspec(novtable) CRefCounted5 : public BASE1, public BASE2, public BASE3, public BASE4, public BASE5,
	public REFCOUNT_SERVICE
{
public:
